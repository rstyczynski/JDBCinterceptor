...
public class Constants {
    ...
    //this object is not interesting for measuremtn. it's physical connection called by wrapper.
...
//    }
    ...
    private static final String[] statementObjectList = {
        ...
        "(none)" //bug in WLS? Sometimes in post object is null...
    };
...
//    }
    ...
    private static final String[] statementMethodCloseList = {
        //Warning: postInvoke is executed with null object, as statement is already closed.
        "close"
    };
    public static final Set<String> statementMethodCloseSet = getStatementMethodCloseSet();
    private static Set<String> getStatementMethodCloseSet(){
        final Set set = new HashSet<String>();
        
        for (String key : statementMethodCloseList ){
          set.add(key);
        }
